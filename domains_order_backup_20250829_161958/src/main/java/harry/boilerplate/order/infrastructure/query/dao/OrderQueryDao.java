package harry.boilerplate.order.infrastructure.query.dao;

import harry.boilerplate.order.application.query.readmodel.OrderHistoryReadModel;
import harry.boilerplate.order.application.query.readmodel.OrderSummaryReadModel;
