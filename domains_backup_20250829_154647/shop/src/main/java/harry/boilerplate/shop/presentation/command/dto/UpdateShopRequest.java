...
public class UpdateShopRequest {
    ...
    public UpdateShopRequest(String name, BigDecimal minOrderAmount) {
        this.name = name;
     ...
     * Command DTO로 변환
     */
    public UpdateShopCommand toCommand(String shopId) {
        return new UpdateShopCommand(shopId, name, minOrderAmount);
    }
