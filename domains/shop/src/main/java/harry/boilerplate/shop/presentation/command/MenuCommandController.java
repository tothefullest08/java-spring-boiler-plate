...
import harry.boilerplate.shop.application.command.handler.AddOptionGroupCommandHandler;
import harry.boilerplate.shop.application.command.handler.CreateMenuCommandHandler;
import harry.boilerplate.shop.application.command.handler.OpenMenuCommandHandler;
import harry.boilerplate.shop.presentation.command.dto.AddOptionGroupRequest;
import harry.boilerplate.shop.presentation.command.dto.CreateMenuRequest;
...
public class MenuCommandController {
    ...
    public ResponseEntity<CommandResultResponse> openMenu(
        ...
        openMenuCommandHandler.handle(new harry.boilerplate.shop.application.command.dto.OpenMenuCommand(menuId));
